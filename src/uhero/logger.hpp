...
#define UH_LOG(fmt, ...) printf(fmt, ##__VA_ARGS__)
#define UH_INFO(fmt, ...) UH_LOG("[INFO] " fmt, ##__VA_ARGS__)
#define UH_WARN(fmt, ...) UH_LOG("[WARN] " fmt, ##__VA_ARGS__)
#define UH_ERROR(fmt, ...) UH_LOG("[ERROR] " fmt, ##__VA_ARGS__)
#define UH_VERB(fmt, ...) UH_LOG("[VERB] " fmt, ##__VA_ARGS__)
